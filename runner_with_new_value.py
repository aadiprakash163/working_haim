...
def setVelocity(VehId):
    ...
    print('Vehicle Id %r entered' %VehId)
    ...
    if lastVeh[rId] != 0.0:     
        while ((lastVehDepTime[rId]) > dep_time + safety_gap*1000):# and V > 0.2:
            V=V-0.01
...
if __name__ == "__main__":
    ...
    sumoProcess = subprocess.Popen(['sumo-gui', "-c", "data/cross.sumocfg", "--step-length", "0.01", "--fcd-output", "fcd_output.xml", 
